...
from raven_agent.scheduler import (
    ScheduledJob,
    SchedulerService,
    compute_fire_at,
    is_cron_expr,
...
class ScheduleTool(Tool):
    ...
    参数:
        service: SchedulerService 实例。
        default_tz: 默认时区，默认 "UTC"。
    """
    ...
    parameters = {
        ...
        "properties": {
            ...
            "channel": {
                "type": "string",
                "description": "目标渠道，如 telegram、cli",
            },
            "chat_id": {
                "type": "string",
                "description": "目标会话 ID",
    ...
    async def execute(self, **kwargs: Any) -> str:
        ...
        输入:
            kwargs: 工具参数字典（见 parameters schema）。
